...
## Висновки
Під час виконання лаборатнрої роботи фактично усе вивчене було для мене новим (окрім версти сторінок і роботи з API). 
У цю лабораторну я вклав усі сили і здібності. Звісно, було багато труднощів, але я так-сяк подолав їх. 
Лабораторна робота банально вказує на те, як повинене виглядати середньостатистичний веб-застосунок. Вона подає нам один із багатьох варіантів, як можна це зробити.